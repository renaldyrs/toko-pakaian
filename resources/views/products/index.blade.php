                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @foreach ($products as $product)
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                            ...
                            <td class="px-6 py-4 text-center text-gray-700 dark:text-gray-300">Rp
    ...
    <div id="addProductModal" class="fixed inset-0 bg-black bg-opacity-50 hidden justify-center items-center">
        <div class="bg-white p-6 rounded-lg w-full max-w-md dark:bg-gray-800">
            ...
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <label for="sizes" class="block text-sm font-medium text-gray-700 dark:text-gray-400">Ukuran dan
                        Stok</label>
                    <div id="size-container">
                        <div class="flex items-center gap-4 mb-2">
                            <input type="text" name="sizes[0][name]" placeholder="Ukuran (contoh: M)"
                                class="block w-1/2 rounded-md border-gray-300 shadow-sm" required>
                            <input type="number" name="sizes[0][stock]" placeholder="Stok"
                                class="block w-1/2 rounded-md border-gray-300 shadow-sm" required>
                            <button type="button"
                                class="bg-red-500 text-white px-2 py-1 rounded-md remove-size">Hapus</button>
                        </div>
                    </div>
                    <button type="button" id="add-size" class="bg-green-500 text-white px-4 py-2 rounded-md">Tambah
                        Ukuran</button>
                </div>
